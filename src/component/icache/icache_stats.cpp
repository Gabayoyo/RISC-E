...
uint32_t ICacheStats::record_block_entry(uint32_t entry_pc) {
...
void ICacheStats::record_instruction(uint32_t pc) {
    ++instructions;
    seen_pcs.insert(pc);
}

void ICacheStats::record_block_instruction(uint32_t block_id) {
